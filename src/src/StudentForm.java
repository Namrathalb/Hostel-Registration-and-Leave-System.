...
public class StudentForm extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5730950015760683308L;
	...
	public StudentForm() {
		...
		JButton btnNewButton = new JButton("Confirm Student");
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=WardenDao.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(StudentForm.this,"Student added successfully!");
				WardenSucess.main(new String[]{});
				frame.dispose();
