...
public class DRFA extends JFrame {
	/**
	 * 
	 */
	...
	public DRFA() {
		...
		JButton btnLibrarianLogin = new JButton("Warden Login");
		btnLibrarianLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Warden.main(new String[]{});
			}
		});
