...
public class WardenSucess extends JFrame {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6609672987168452473L;
	static WardenSucess frame;
	...
	public WardenSucess() {
		...
		JLabel lblAdminSection = new JLabel("Warden");
		...
		JButton btnViewLibrarian = new JButton("View Students");
